            ...
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        ...
                        <hr>
                        <form @submit.prevent="edit(this.id_jadwal_umum)">
...
<script>
    ...
    setup() {
        ...
        axios
            .get(`https://pam.ppcdeveloper.com/api/jadwal_umum/${route.params.id_jadwal_umum}`,)
            .then((response) => {
            //assign state posts with response data
            // instruktur.value = response.data.data;
            jadwal_umum.value.id_instruktur = response.data.data.id_instruktur
            jadwal_umum.value.id_kelas = response.data.data.id_kelas
            jadwal_umum.value.hari = response.data.data.hari
            jadwal_umum.value.jam_mulai = response.data.data.jam_mulai
            jadwal_umum.value.jam_selesai = response.data.data.jam_selesai
            jadwal_umum.value.tanggal = response.data.data.tanggal
            jadwal_umum.value.keterangan = response.data.data.keterangan
            })
            .catch((error) => {
        ...
        function edit($id_jadwal_umum) {
            ...
            let tanggal = jadwal_umum.value.tanggal
            let keterangan = jadwal_umum.value.keterangan

            axios.put('https://pam.ppcdeveloper.com/api/jadwal_umum/' + $id_jadwal_umum, {
